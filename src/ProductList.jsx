...
function ProductList() {
    ...
    const isAddedItem = (productName) => {
        return productName in addedToCart;
    }

    const onDeleteItem = (productName) => {
        const {[productName]: _, ...newState} = addedToCart;
    ...
    return (
        <div>
            ...
            </div>
            {
                                            ...
                                            {category.plants.map((plant, plantIndex) => (
                                                <div className="product-card" key={plantIndex}>
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={isAddedItem(plant.name)}
                                                    >
                                                        Add to Cart
                                                    </button>
                                                </div>
                ...
                : (
                    <CartItem onContinueShopping={handleContinueShopping} onDeleteItem={onDeleteItem} />
                )
            }
        </div>
    );
